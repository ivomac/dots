...
vim.api.nvim_create_user_command("Close", function() end, {})
...
vim.keymap.set("n", "<leader>te", RunScript, { desc = "Run current script" })


-- Yazi

function Yazi(file)
	local cmd = "yazi " .. (file or vim.api.nvim_buf_get_name(0))
...
vim.keymap.set("n", "<leader>ty", Yazi, { noremap = true, silent = true, desc = "File explorer" })
